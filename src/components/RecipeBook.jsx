...
const S = {
  ...
  savedImage: { width: "100%", aspectRatio: "1 / 1", objectFit: "contain", borderRadius: 9, marginBottom: 7, background: "#F7FAFC" },
  ...
  viewerImage: { display: "block", width: "100%", height: "auto", maxHeight: "70vh", objectFit: "contain", borderRadius: 10, background: "#F7FAFC" },
  ...
  recipeImage: { width: "100%", aspectRatio: "4 / 3", objectFit: "contain", borderRadius: 9, background: "#F7FAFC", marginBottom: 7 },
